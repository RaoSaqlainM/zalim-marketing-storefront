...
const copy: Record<OrderEmailMilestone, { subject: string; title: string; message: string }> = {
  ...
  confirmed: { subject: "Your AutoGear order is confirmed", title: "Your order is confirmed.", message: "Payment has been confirmed and our team is preparing your selection for dispatch." },
  shipped: { subject: "Your AutoGear order is on the road", title: "Your order is on the road.", message: "Your order has been handed to delivery and is making its way to you." },
};
