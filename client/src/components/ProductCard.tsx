...
function ProductVisualFallback({ sku }: { sku: string }) {
  return <span aria-hidden="true" className="absolute inset-0 flex flex-col justify-between bg-[linear-gradient(145deg,#14233b_0%,#0d1728_58%,#a77a2a_180%)] p-4 text-white"><span className="w-fit border border-[#dfc47e]/50 px-2 py-1 text-[9px] font-bold uppercase tracking-[.16em] text-[#f1d485]">Zalim selection</span><span><span className="block font-display text-3xl font-bold leading-none tracking-[-.05em]">Road-ready</span><span className="mt-1 block text-[10px] font-bold uppercase tracking-[.15em] text-slate-300">{sku}</span></span></span>;
}
