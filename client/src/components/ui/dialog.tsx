...
function Dialog({ ...props }: React.ComponentProps<typeof DialogPrimitive.Root>) {
    ...
    return (<DialogCompositionContext.Provider value={contextValue}>
...
function DialogContent({ className, children, showCloseButton = true, onEscapeKeyDown, ...props }: React.ComponentProps<typeof DialogPrimitive.Content> & {
