...
export default function Cart() {
  ...
  if (!isAuthenticated) return <StorefrontLayout><div className="container py-16"><EmptyState title="Your selection is waiting." text="Sign in to keep your chosen essentials together and move through checkout when the store is ready to accept payment." action={{ label: "Sign in to shop", href: "/account" }} /><Button className="sr-only" onClick={startLogin}>Sign in</Button></div></StorefrontLayout>;
